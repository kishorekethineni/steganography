package c.chaitu.steganographylibrary.Text;
...
import c.chaitu.steganographylibrary.Text.AsyncTaskCallback.TextDecodingCallback;
import c.chaitu.steganographylibrary.Utils.Utility;
...
public class TextDecoding extends AsyncTask<ImageSteganography, Void, ImageSteganography> {
    ...
    public TextDecoding(AppCompatActivity activity, TextDecodingCallback textDecodingCallback) {
        super();
