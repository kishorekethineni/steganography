...
import c.chaitu.steganographylibrary.Text.AsyncTaskCallback.TextEncodingCallback;
...
public class TextEncoding extends AsyncTask<ImageSteganography, Integer, ImageSteganography> {
    ...
    public TextEncoding(AppCompatActivity activity, TextEncodingCallback callbackInterface) {
        super();
